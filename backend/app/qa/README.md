...
failure = TestFailure(
    ...
    stack_trace="...",
    file_path="backend/tests/test_margins.py",
    line_number=42,
    test_code="...",
    source_code="..."
)
...
if analysis['confidence'] >= 85:
    ...
    result = fixer.apply_fix(
        file_path="backend/app/services/margins.py",
    ...
    if result['applied']:
        ...
        test_file = Path("backend/tests/regression/test_margin_regression.py")
...
Analyzing failure 1/1: test_calculate_margin
  ...
  📝 Changes:
  --- backend/app/services/margins.py
  +++ backend/app/services/margins.py (fixed)
  @@ -10,6 +10,8 @@
  ...
  ✅ Regression test saved: backend/tests/regression/test_calculate_margin_regression.py
