    ...
    def cooperatives_to_csv(cooperatives: List[Any]) -> StreamingResponse:
        ...
        for coop in cooperatives:
            data.append({
                ...
                "Altitude Min (masl)": coop.altitude_min or "",
                "Altitude Max (masl)": coop.altitude_max or "",
                "Hectares": coop.hectares or "",
                "Farmer Count": coop.farmer_count or "",
                "Contact Email": coop.contact_email or "",
                "Contact Phone": coop.contact_phone or "",
                "Website": coop.website or "",
                "Certifications": ", ".join(coop.certifications or []),
                "Varietals": ", ".join(coop.varietals or []),
                "Processing Methods": ", ".join(coop.processing_methods or []),
                "Created At": coop.created_at,
                "Updated At": coop.updated_at,
            })

        filename = f"cooperatives_export_{datetime.utcnow().strftime('%Y%m%d_%H%M%S')}.csv"
    ...
    def roasters_to_csv(roasters: List[Any]) -> StreamingResponse:
        ...
        for roaster in roasters:
            data.append({
                ...
                "Country": roaster.country or "",
                "Contact Email": roaster.contact_email or "",
                "Contact Phone": roaster.contact_phone or "",
                "Website": roaster.website or "",
                "Annual Volume (kg)": roaster.annual_volume_kg or "",
                "Specialty Focus": roaster.specialty_focus,
                "Preferred Origins": ", ".join(roaster.preferred_origins or []),
                "Preferred Profiles": ", ".join(roaster.preferred_profiles or []),
