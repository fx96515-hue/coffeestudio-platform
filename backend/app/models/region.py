...
class Region(Base, TimestampMixin):
    ...
    # Risk factors
    weather_risk: Mapped[str | None] = mapped_column(String(32), nullable=True)  # low/medium/high
    political_risk: Mapped[str | None] = mapped_column(String(32), nullable=True)  # low/medium/high
    logistics_risk: Mapped[str | None] = mapped_column(String(32), nullable=True)  # low/medium/high
