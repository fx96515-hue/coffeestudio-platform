...
class EntityEvidence(Base, TimestampMixin):
    ...
    entity_type: Mapped[str] = mapped_column(String(32), nullable=False)  # cooperative|roaster
    ...
    __table_args__ = (
        UniqueConstraint("entity_type", "entity_id", "evidence_url", name="uq_entity_evidence"),
    )
