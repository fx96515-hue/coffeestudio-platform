...
def test_generate_outreach_with_llm_refinement(db):
    ...
    with patch("app.services.outreach.settings") as mock_settings, \
...
def test_template_sourcing_pitch_de():
    ...
    text = _template("de", purpose="sourcing_pitch", entity=mock_entity, counterpart="Max")
...
def test_template_sample_request_en():
    ...
    text = _template("en", purpose="sample_request", entity=mock_entity, counterpart="Team")
...
def test_template_spanish_language():
    ...
    text = _template("es", purpose="sourcing_pitch", entity=mock_entity, counterpart=None)
