...
2. `backend/app/middleware/security_headers.py` - Security headers
3. `backend/app/middleware/input_validation.py` - Attack detection
4. `backend/app/core/error_handlers.py` - Error handling
5. `backend/app/core/audit.py` - Audit logging
6. `backend/app/core/export.py` - Data export
7. `backend/tests/test_middleware.py` - Middleware tests
8. `backend/tests/test_export.py` - Export tests
...
**Backend (4):**
1. `backend/app/main.py` - Middleware & error handler integration
2. `backend/app/api/routes/cooperatives.py` - Export endpoint
3. `backend/app/api/routes/roasters.py` - Export endpoint
4. `backend/tests/test_auth.py` - Updated for new error format
