...
- `backend/alembic/versions/0009_peru_sourcing_intelligence_v0_4_0.py` (92 lines)
- `backend/alembic/env.py` (modified - added Region import)
- `backend/app/models/region.py` (52 lines)
- `backend/app/models/cooperative.py` (modified - 7 new JSONB fields)

#### Business Logic Layer (5 files)
- `backend/app/services/data_sources/__init__.py` (1 line)
...
#### API Layer (3 files)
- `backend/app/schemas/peru_sourcing.py` (132 lines)
- `backend/app/api/routes/peru_sourcing.py` (145 lines)
- `backend/app/api/router.py` (modified - added peru_sourcing import)

#### Testing Layer (5 files)
- `backend/tests/test_supply_capacity_scoring.py` (120 lines, 4 tests)
- `backend/tests/test_export_readiness_check.py` (125 lines, 4 tests)
- `backend/tests/test_risk_calculation.py` (95 lines, 3 tests)
- `backend/tests/test_price_benchmarking.py` (105 lines, 4 tests)
- `backend/tests/test_peru_sourcing_api.py` (180 lines, 11 tests)
