...
def upgrade():
    # --- workflow fields ---
    op.add_column("cooperatives", sa.Column("status", sa.String(length=32), nullable=False, server_default="active"))
    op.add_column("cooperatives", sa.Column("next_action", sa.String(length=255), nullable=True))
    op.add_column("cooperatives", sa.Column("requested_data", sa.Text(), nullable=True))
    op.add_column("cooperatives", sa.Column("last_verified_at", sa.DateTime(timezone=True), nullable=True))
    op.add_column("cooperatives", sa.Column("last_scored_at", sa.DateTime(timezone=True), nullable=True))
    op.create_index("ix_cooperatives_status", "cooperatives", ["status"], unique=False)

    op.add_column("roasters", sa.Column("status", sa.String(length=32), nullable=False, server_default="active"))
    op.add_column("roasters", sa.Column("next_action", sa.String(length=255), nullable=True))
    op.add_column("roasters", sa.Column("requested_data", sa.Text(), nullable=True))
    op.add_column("roasters", sa.Column("last_verified_at", sa.DateTime(timezone=True), nullable=True))
    op.add_column("roasters", sa.Column("last_scored_at", sa.DateTime(timezone=True), nullable=True))
    ...
    op.create_index("ix_market_observations_key", "market_observations", ["key"], unique=False)
    op.create_index("ix_market_observations_observed_at", "market_observations", ["observed_at"], unique=False)
    op.create_index("ix_market_key_observed_at", "market_observations", ["key", "observed_at"], unique=False)
    ...
    op.create_index("ix_reports_kind_report_at", "reports", ["kind", "report_at"], unique=False)
    ...
    op.create_index("ix_lots_coop_name", "lots", ["cooperative_id", "name"], unique=False)
    ...
    op.create_table(
        ...
        sa.Column("profile", sa.String(length=64), nullable=False, server_default="conservative"),
    ...
    op.create_index("ix_margin_runs_computed_at", "margin_runs", ["computed_at"], unique=False)
    op.create_index("ix_margin_runs_lot_profile", "margin_runs", ["lot_id", "profile"], unique=False)
