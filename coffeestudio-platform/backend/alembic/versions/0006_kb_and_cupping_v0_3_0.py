...
def upgrade():
    ...
    op.create_index("ix_knowledge_docs_category", "knowledge_docs", ["category"], unique=False)
    ...
    op.create_table(
        ...
        sa.Column("cooperative_id", sa.Integer(), sa.ForeignKey("cooperatives.id"), nullable=True),
        sa.Column("lot_id", sa.Integer(), sa.ForeignKey("lots.id"), nullable=True),
        sa.Column("roaster_id", sa.Integer(), sa.ForeignKey("roasters.id"), nullable=True),
    ...
    op.create_index("ix_cupping_results_cooperative_id", "cupping_results", ["cooperative_id"], unique=False)
    op.create_index("ix_cupping_results_lot_id", "cupping_results", ["lot_id"], unique=False)
    op.create_index("ix_cupping_results_roaster_id", "cupping_results", ["roaster_id"], unique=False)
