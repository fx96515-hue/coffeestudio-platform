...
def upgrade():
    ...
    op.add_column("entity_evidence", sa.Column("retrieved_at", sa.DateTime(timezone=True), nullable=True))
    op.add_column("entity_evidence", sa.Column("confidence", sa.Float(), nullable=True))
    op.add_column("entity_evidence", sa.Column("extractor", sa.String(length=64), nullable=True))
    op.add_column("entity_evidence", sa.Column("snippet_hash", sa.String(length=64), nullable=True))
    ...
    op.create_index("ix_entity_aliases_entity_type", "entity_aliases", ["entity_type"], unique=False)
    ...
    op.create_index("ix_entity_events_entity_type", "entity_events", ["entity_type"], unique=False)
    op.create_index("ix_entity_events_entity_id", "entity_events", ["entity_id"], unique=False)
    op.create_index("ix_entity_events_event_type", "entity_events", ["event_type"], unique=False)
    op.create_index("ix_entity_events_entity_type_id", "entity_events", ["entity_type", "entity_id"], unique=False)
    ...
    op.create_index("ix_web_extracts_entity_type", "web_extracts", ["entity_type"], unique=False)
    op.create_index("ix_web_extracts_entity_id", "web_extracts", ["entity_id"], unique=False)
    op.create_index("ix_web_extracts_retrieved_at", "web_extracts", ["retrieved_at"], unique=False)
    op.create_index("ix_web_extracts_entity_type_id", "web_extracts", ["entity_type", "entity_id"], unique=False)
    ...
    op.create_index("ix_news_items_retrieved_at", "news_items", ["retrieved_at"], unique=False)
    op.create_index("ix_news_topic_retrieved", "news_items", ["topic", "retrieved_at"], unique=False)
