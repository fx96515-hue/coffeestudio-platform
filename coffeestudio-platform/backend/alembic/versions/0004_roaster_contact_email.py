...
def upgrade():
    op.add_column("roasters", sa.Column("contact_email", sa.String(length=320), nullable=True))
    op.create_index("ix_roasters_contact_email", "roasters", ["contact_email"], unique=False)
