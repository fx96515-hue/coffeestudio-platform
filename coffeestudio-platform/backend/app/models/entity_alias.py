...
class EntityAlias(Base, TimestampMixin):
    ...
    entity_type: Mapped[str] = mapped_column(String(32), nullable=False, index=True)  # cooperative|roaster
    entity_id: Mapped[int] = mapped_column(Integer, nullable=False, index=True)
    alias: Mapped[str] = mapped_column(String(255), nullable=False)
    kind: Mapped[str | None] = mapped_column(String(32), nullable=True)  # name|domain|social|other
