from sqlalchemy import String, Text, Float, JSON, Integer, DateTime, ForeignKey, Index
...
class Lot(Base, TimestampMixin):
    ...
    cooperative_id: Mapped[int] = mapped_column(ForeignKey("cooperatives.id"), nullable=False, index=True)

    name: Mapped[str] = mapped_column(String(255), nullable=False)
    crop_year: Mapped[int | None] = mapped_column(Integer, nullable=True)

    incoterm: Mapped[str | None] = mapped_column(String(16), nullable=True)  # FOB|CIF|...
