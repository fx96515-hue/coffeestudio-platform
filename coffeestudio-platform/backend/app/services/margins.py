...
def calc_margin(req: MarginCalcRequest) -> Tuple[Dict, Dict]:
    ...
    total_cost_per_kg_roasted = cost_per_kg_roasted_from_green + float(req.roast_and_pack_costs_per_kg)
    ...
    if req.fx_usd_to_eur and req.purchase_currency.upper() == "USD" and req.selling_currency.upper() == "EUR":
