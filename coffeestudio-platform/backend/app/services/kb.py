...
DEFAULT_DOCS: list[dict[str, Any]] = [
    {
        ...
        "content_md": (
            ...
            "### Ziel\\n"
            "Rohkaffee (grün) aus Peru in DE importieren, anschließend Verkauf an Röstereien.\\n\\n"
            "### Minimaler Ablauf (high-level)\\n"
            "1. Lieferant verifizieren (Kooperative/Exporter, Dokumente, Referenzen)\\n"
            "2. Spezifikationen (Varietäten, Processing, Ernte, Feuchte, Screen, Defects, SCA Score)\\n"
            "3. Muster: Cupping + Qualitätsfreigabe\\n"
            ...
            "9. Vertrieb: Preisschema, Samples an Röster, Kommunikation/CRM\\n\\n"
            "### CoffeeStudio Nutzung\\n"
            "- Kooperative/Röster: `status`, `next_action`, `evidence_count`\\n"
