...
def refresh_news(db: Session, *, topic: str = "coffee", country: str | None = None, max_items: int = 25) -> dict[str, Any]:
    ...
    try:
        ...
        for q in queries:
            try:
                results = client.search(q, max_results=10, country=country or "DE", max_tokens_per_page=384)
                for r in results:
        ...
        return {"status": "ok", "topic": topic, "created": created, "updated": updated, "errors": errors}
    finally:
        client.close()