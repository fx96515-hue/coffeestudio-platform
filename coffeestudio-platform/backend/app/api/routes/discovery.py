...
class SeedRequest(BaseModel):
    ...
    dry_run: bool = False
    country_filter: Optional[str] = Field(None, description="Override country filter (PE|DE)")
...
def get_seed_status(task_id: str, _=Depends(require_role("admin","analyst","viewer"))):
